...
enum WordID
{
  WORD_OF_AIR, WORD_OF_WATER, WORD_OF_EARTH, WORD_OF_FIRE,
...
enum LanguageID
{
  IMPERIAL, ANCIENT_IMPERIAL, ELVISH, ANCIENT_ELVISH, DWARVISH,
  ANCIENT_DWARVISH, GNOMISH, ANCIENT_GNOMISH, MER, ANCIENT_MER, GESH, VENTARRI,
  ANCIENT_VENTARRI, TOTAL_LANGUAGE_IDS
};
enum LocationID
{
  ILLARUM_ENTRANCE, ILLARUM_MARKET, ILLARUM_INN, ILLARUM_SCHOOL,
...
enum GameCharID
{
  PLAYER, HUMAN, SOLDIER, KNIGHT, WIZARD, PEASANT, MERCHANT, INNKEEPER,
...
{
  INVISIBLE, FLYING, WATER_BREATHING, FIRE_FORM,
  EARTH_FORM, WIND_FORM, WATER_FORM, ASLEEP, PARALYZED, POISONED, SILENCED,
  IN_COMBAT, SUMMONED, INANIMATE, TOTAL_STATUS_IDS
};
enum ItemID
{
  FOOD, HEALING_POTION, GLOWING_MUSHROOM, TOTAL_ITEM_IDS
};
enum MissionID
{
  ELEMENTS1, ELEMENTS2, ELEMENTS3, ELEMENTS4, ELEMENTS5, MIND1,
...
enum MissionStatus
{
  CLOSED, OPEN, COMPLETED, TERMINATED, FAILED
};
enum GroupID
{
  ELEMENTS_GUILD, MIND_GUILD, THE_DRUIDS, THE_ELVES, THE_DWARVES,
