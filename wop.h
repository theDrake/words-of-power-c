...
Brief Description:
  Header file for the fantasy RPG "Words of Power."
...
enum WordID {WORD_OF_AIR, WORD_OF_WATER, WORD_OF_EARTH, WORD_OF_FIRE,
  ...
  WORD_OF_DEATH, WORD_OF_HOLINESS, WORD_OF_EVIL, WORD_OF_GIVING, WORD_OF_TAKING,
  WORD_OF_INCREASE, WORD_OF_DECREASE, WORD_OF_BALANCE, WORD_OF_SHIELDING,
  WORD_OF_WAVES, WORD_OF_FOCUS, WORD_OF_TIME, WORD_OF_VOID, TOTAL_WORD_IDS};
...
enum LocationID {ILLARUM_ENTRANCE, ILLARUM_MARKET, ILLARUM_INN, ILLARUM_SCHOOL,
  ...
  ISHTARR_ENTRANCE, ISHTARR_EAST_WING, ISHTARR_WEST_WING, ISHTARR_CENTRAL_TOWER,
  ISHTARR_DUNGEON, SHORE_NE, SHORE_EAST, SHORE_SE, OCEAN_SURFACE, OCEAN_SHALLOW,
  OCEAN_DEEP, OCEAN_TRENCH, QUELACENTUS_ENTRANCE, QUELACENTUS_PLAZA,
  QUELACENTUS_TEMPLE, QUELACENTUS_PALACE, TOTAL_LOCATION_IDS};
